...
def setJoy(valueX, valueY, valueZ, buttons, scale):
    xPos = int(valueX*scale)
    yPos = int(valueY*scale)
    zPos = int(valueZ*scale)
    joystickPosition = vj.generateJoystickPosition(wAxisX = 16000+xPos, wAxisY = 16000+yPos, wAxisZ = 16000+zPos, lButtons = buttons)
